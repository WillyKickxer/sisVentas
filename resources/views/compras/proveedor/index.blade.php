	...
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
			<h3>Listado de Proveedores
				<a href="proveedor/create"><!--href: carpeta/vista-->
					<button class="btn btn-success">
						<i class="fa fa-plus-circle" aria-hidden="true"></i> Nuevo
					</button>
				</a>
			</h3><!--href: carpeta/vista-->
			@include('compras.proveedor.search')<!--Carpeta:compras; Subcarpeta:proveedor; Vista:search-->
		</div>
	</div>
					...
					<tr> <!--segunda fila que muestra el total de registros-->
						...
						<td>
							<a href="{{ URL::action('ProveedorController@edit', $per->idpersona) }}">
								<button class="btn btn-warning" title="Editar Proveedor">
							...
							</a> <!--obtiene el id de la persona que se quiere elimar-->
						</td>
					</tr>
					@include('compras.proveedor.modal') <!--por cada persona se asigna un modal-->
					@endforeach
				</table>
			</div>
