...
@section ('contenido') <!--se mostrará en la seccion de "contenido"-->
	...
	{!! Form::model($persona, ['method'=>'PATCH', 'route'=>['compras.proveedor.update', $persona->idpersona]]) !!} <!--recibe la persona (cliente) con el motodo patch para que pueda enviar la funcion edit del controlador, envia como parametro la id de la persona-->
	{{ Form::token() }}
