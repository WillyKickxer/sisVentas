	...
	<div class="row">
		...
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group">
				...
				<button class="btn btn-default" type="reset" data-toggle="tooltip" data-placement="left">
					<i class="fa fa-magic" aria-hidden="true"></i> Limpiar
				</button>
				<a href="../cliente" class="btn btn-danger"><i class="fa fa-ban fa-fw"></i>Cancelar</a>
			</div>
		</div>
	</div>
