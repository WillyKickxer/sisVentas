...
<html>
  <head>
    ...
    <!--HOJAS DE ESTILO-->
    <!--se agrega asset a cada hipervinculo para indicar que el estilo está en la carpeta public-->
    <!-- Bootstrap 3.3.5 -->
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Wilton Contreras</span>
                </a>
              ...
              <div class="box">
                ...
                <div class="box-body">
                  	<div class="row">
	                  	<div class="col-md-12">
		                          <!--Contenido-->
                              @yield('contenido') <!--cuando se hace referencia a esta plantilla blade(admin.blade.php) puede agregarse una seccion llamada "contenido" mediante yield-->
		                          <!--Fin Contenido-->
                           </div>
                        </div>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2021 <a href="">Willykickxer.SA</a></strong> All rights reserved.
      </footer>

    <!--se agrega asset a cada hipervinculo para indicar que el estilo está en la carpeta public-->
    <!-- jQuery 2.1.4 -->
    <script src="{{ asset('js/jQuery-2.1.4.min.js') }}"></script>
    @stack('scripts') <!--si se extiende la plantilla (admin.blade.php) desde otra plantilla, cuando se haga uso del scripts (puede cambiar el nombre) se podrá utilizar el scripts-->
    <!-- Bootstrap 3.3.5 -->
